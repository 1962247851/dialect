...
public class FragmentStaggeredNewest extends Fragment {
    private static final String TAG = "FragmentStaggeredNewest----->";
    ...
    public FragmentStaggeredNewest() {
    }

    @SuppressLint("ValidFragment")
    public FragmentStaggeredNewest(IStaggeredListeners i) {

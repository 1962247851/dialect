...
public class FragmentStaggeredPopular extends Fragment {
    private static final String TAG = "FragmentStaggeredPopular----->";
    ...
    public FragmentStaggeredPopular() {
    }

    @SuppressLint("ValidFragment")
    public FragmentStaggeredPopular(IStaggeredListeners i) {
